    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div ref={modalRef} className="bg-white rounded-lg p-6 w-full max-w-md mx-4 relative">
        ...
        <div className="space-y-3">
          ...
          >
            {loading ? (
              <div className="animate-spin w-5 h-5 border-2 border-gray-300 border-t-[#4285F4] rounded-full" />
            ) : (
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#24292e] text-white rounded-lg hover:bg-[#1c2127] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <div className="animate-spin w-5 h-5 border-2 border-gray-300 border-t-white rounded-full" />
            ) : (

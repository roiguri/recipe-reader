...
/**
 * MyRecipesPage component - Sectioned layout version for displaying user's saved recipes
 */
const MyRecipesPage = ({ onNavigateHome }) => {
  ...
  // Get expanded recipe data for display
  const expandedRecipeData = expandedRecipe ? recipes.find(r => r.id === expandedRecipe) : null;

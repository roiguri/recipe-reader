...
const QuotaExceeded = ({ onClose }) => {
  ...
  const handleContactUs = () => {
    ...
    window.location.href = 'mailto:contact@recipe-api.com?subject=API Access Request&body=Hello, I would like to request API access for recipe processing.';
  };
  ...
  return (
    <Card className="my-6">
      <div className="p-6 text-center">
        ...
        {/* Title */}
        <h3 className={`text-xl font-bold text-gray-900 mb-2 leading-relaxed ${isRTL ? 'text-right' : 'text-left'}`}>
          {t('quota.exceeded.title')}
        </h3>

        {/* Description */}
        <p className={`text-gray-600 mb-6 max-w-md mx-auto leading-relaxed ${isRTL ? 'text-right' : 'text-left'}`}>
        ...
        {/* Action Buttons */}
        <div className={`flex flex-col sm:flex-row gap-3 justify-center ${isRTL ? 'space-x-reverse' : ''}`}>
          <Button 
